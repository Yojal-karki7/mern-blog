...
const DashProfile = () => {
  ...
  const uploadImageToCloudinary = async () => {
    ...
    try {
      ...
      formData.append('cloud_name', 'dtijdjc5e'); // Replace with your Cloudinary cloud name

      const res = await fetch('https://api.cloudinary.com/v1_1/dtijdjc5e/image/upload', {
        method: 'POST',
        body: formData,
      });
